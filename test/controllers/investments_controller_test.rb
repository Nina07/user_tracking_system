...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { amount: @investment.amount, month: @investment.month, total_inv: @investment.total_inv }
    end
  ...
  test "should update investment" do
    patch :update, id: @investment, investment: { amount: @investment.amount, month: @investment.month, total_inv: @investment.total_inv }
    assert_redirected_to investment_path(assigns(:investment))
  end
